...
namespace URL_Shortener.BLL.Mapper
{
    public class MappingProfile : Profile
    {
        ...
        {           
            ...
            CreateMap<UrlDTO, Url>().ReverseMap().ForMember(dest => dest.UserId, opt => opt.MapFrom(x => x.UserAccountId)).ForMember(dest => dest.UserEmail, opt => opt.MapFrom(x => x.UserAccount.Email));
        }
    }
}
